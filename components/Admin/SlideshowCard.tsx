...
// interface ISlideshowCardState {}

class SlideshowCard extends Component<ISlideshowCardProps> {
  ...
  render() {
    ...
    return (
      <Link href={`/slideshow/${value._id}?display=${displayId}`} passHref legacyBehavior>
            ...
            <div className='right-actions'> {/* Renamed class */}
              <div 
                ...
                onClick={(e: React.MouseEvent<HTMLDivElement>) => {
                  this.handleDelete(e as any); // Cast event if needed for FontAwesome's own onClick
                }}
                role="button"
                tabIndex={0}
