  ...
  return (
    <div className="p-3 font-sans rounded cursor-pointer bg-white mt-10 mb-10 flex flex-row justify-center relative transition-shadow duration-200">
      ...
      <div className="font-sans flex flex-col justify-center pl-2 pr-2 flex-1">
        <div className="font-sans text-base overflow-hidden whitespace-nowrap text-ellipsis text-gray-600 mb-2">{value?.name || 'Untitled Display'}</div>
      ...
      <div className="flex flex-row font-sans justify-center items-center pl-2 pr-2">
        <div className="mr-2 ml-2 p-2 rounded-full transition-colors duration-200 hover:bg-gray-100 flex items-center justify-center cursor-pointer" onClick={handleEdit} aria-label='Edit Layout'>
          <Eye className="w-4 h-4 text-gray-500" />
        </div>
        <div className="mr-2 ml-2 p-2 rounded-full transition-colors duration-200 hover:bg-gray-100 flex items-center justify-center cursor-pointer" onClick={handleView} aria-label='View Display'>
          <ExternalLink className="w-4 h-4 text-gray-500" />
        </div>
        <div className="mr-2 ml-2 p-2 rounded-full transition-colors duration-200 hover:bg-gray-100 flex items-center justify-center cursor-pointer" onClick={handleDelete} aria-label='Delete Display'>
