...
import Widgets, { IWidgetDefinition } from '../../widgets'; // Assuming widgets/index.js is or will be typed
...
// interface IEditableWidgetState {}

class EditableWidget extends React.Component<IEditableWidgetProps> {
  // Typing the ref to the WidgetEditDialog instance
  private dialog = React.createRef<IWidgetEditDialog>();

  constructor(props: IEditableWidgetProps) {
    super(props);
  }
  ...
  handleDeleteClick = (e?: React.MouseEvent): void => {
    if (e) e.stopPropagation();
    this.props.onDelete(); // Call the onDelete prop passed from parent
  };
    ...
    return (
      <div className={'widget-editable-container'}>
        <div className={'controls'}>
          <div className={'edit-btn'} onClick={this.openDialog} role="button" tabIndex={0}>
            <FontAwesomeIcon icon={faCog} size={'xs'} fixedWidth />
          </div>
          <div className={'delete-btn'} onClick={this.handleDeleteClick} role="button" tabIndex={0}>
