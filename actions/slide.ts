...
export const deleteSlide = (
  ...
  return axios
    .delete<unknown>(`${host}/api/v1/slide/${id}`)
    .then((res: AxiosResponse<unknown>) => {
...
export const updateSlide = (
  ...
  return axios
    .patch<unknown>(`${host}/api/v1/slide/${id}`, formData, {
      headers: {
...
export const addSlide = (
  ...
  return axios
    .post<unknown>(`${host}/api/v1/slide`, formData, {
      headers: {
...
export const standaloneUpload = (
  ...
  formData.append('slideFile', file)
  return axios
    .post<unknown>(`${host}/api/v1/slide/standalone_upload`, formData, {
      headers: {
        // "Content-Type": "multipart/form-data", // Axios sets this
      },
    })
